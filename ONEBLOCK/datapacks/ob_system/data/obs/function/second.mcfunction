...
execute as @e[tag=cob.block,limit=1] if score @e[tag=cob.block,limit=1] cob.trader matches 2880.. if predicate obs:chances/9 if predicate obs:chances/4 run function obs:random_trader
