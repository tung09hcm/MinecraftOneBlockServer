...
execute if score #cob.temp_1 cob.block matches 4 run summon minecraft:ominous_item_spawner ~ ~5 ~ {item:{id:"minecraft:fire_charge",count:1},spawn_item_after_ticks:80}
execute if score #cob.temp_1 cob.block matches 5 run summon minecraft:ominous_item_spawner ~ ~5 ~ {item:{id:"minecraft:wind_charge",count:1},spawn_item_after_ticks:80}
