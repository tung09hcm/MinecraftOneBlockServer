...
execute if entity @e[tag=cob.block,tag=cob.ominous] if predicate obs:chances/3 run function obs:trial_handler/item_spawn/main
execute if entity @e[tag=cob.block,tag=cob.ominous] if score #cob.trial.wave cob.trial matches 33.. if predicate obs:chances/4 run function obs:trial_handler/item_spawn/main
execute if entity @e[tag=cob.block,tag=cob.ominous] if score #cob.trial.wave cob.trial matches 75.. if predicate obs:chances/3 run function obs:trial_handler/item_spawn/main
execute if score #cob.temp_1 cob.trial >= @e[tag=cob.block,limit=1] cob.mob_cap if entity @e[tag=cob.block,tag=cob.ominous] if predicate obs:chances/2 run function obs:trial_handler/item_spawn/main