...
execute if entity @e[tag=cob.block,tag=cob.ominous] if score #cob.trial.wave_max cob.trial matches 50.. run scoreboard players set #cob.trial.wave_max cob.trial 50
