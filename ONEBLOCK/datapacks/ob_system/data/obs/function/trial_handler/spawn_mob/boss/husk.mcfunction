...
summon husk ~ ~ ~ {PersistenceRequired:1b,Tags:["cob.trial_mob","cob.trial_boss","cob.trial_boss.husk","cob.spawned"],active_effects:[{id:"minecraft:trial_omen",amplifier:1,duration:-1,show_particles:1b,ambient:1b}],ArmorDropChances:[-327.670F,-327.670F,-327.670F,-327.670F],HandDropChances:[-327.670F,-327.670F],Health:70f,attributes:[{id:generic.knockback_resistance,base:0.75},{id:generic.max_health,base:120},{id:generic.scale,base:1.025}],DeathLootTable:"obs:entity/trial_boss"}

attribute @e[tag=cob.spawned,limit=1] minecraft:generic.movement_speed modifier add obs:boss_speed 0.3 add_multiplied_base
attribute @e[tag=cob.spawned,limit=1] minecraft:generic.explosion_knockback_resistance base set 0.35
