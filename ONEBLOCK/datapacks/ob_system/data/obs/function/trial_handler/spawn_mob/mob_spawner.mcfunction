...
execute as @e[tag=cob.mob_spawner] if score #cob.trial.wave cob.trial matches 15..39 if predicate obs:chances/5 run function obs:trial_handler/spawn_mob/special/elite
execute as @e[tag=cob.mob_spawner] if score #cob.trial.wave cob.trial matches 40.. if predicate obs:chances/4 run function obs:trial_handler/spawn_mob/special/elite
...
execute as @e[tag=cob.mob_spawner] if score #cob.trial.wave cob.trial matches 5.. if predicate obs:chances/4 run function obs:trial_handler/spawn_mob/special/breeze_non_priority
