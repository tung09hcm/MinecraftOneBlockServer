...
summon skeleton ~ ~ ~ {PersistenceRequired:1b,Tags:["cob.trial_mob","cob.trial_boss","cob.trial_boss.skeleton","cob.spawned"],active_effects:[{id:"minecraft:trial_omen",amplifier:1,duration:-1,show_particles:1b,ambient:1b}],ArmorDropChances:[-327.670F,-327.670F,-327.670F,-327.670F],HandDropChances:[-327.670F,-327.670F],Health:70f,attributes:[{id:generic.max_health,base:120},{id:generic.scale,base:1.025}],DeathLootTable:"obs:entity/trial_boss"}
