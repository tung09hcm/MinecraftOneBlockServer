...
execute if score #cob.trial.wave cob.trial matches 5.. run function obs:trial_handler/spawn_mob/boss/ability_rng
execute if score #cob.trial.wave cob.trial matches 20.. run function obs:trial_handler/spawn_mob/boss/ability_rng
execute if score #cob.trial.wave cob.trial matches 35.. run function obs:trial_handler/spawn_mob/boss/ability_rng
execute if score #cob.trial.wave cob.trial matches 50.. run function obs:trial_handler/spawn_mob/boss/ability_rng
